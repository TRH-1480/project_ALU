...
module CPU_tb;
    ...
    wire [15:0] result,result1,result2;//ALUの出力,Muxの出力,レジスタの出力
    parameter STEP = 100;
    ...
    initial begin
       ...
       //リセットの有効化 
        ...
        // テストケース2: レジスタの書き込みの確認
        #STEP we = 1;
        inaddr = 3'b001;
        #STEP we = 0;
        
        //テストケース3：　アドレスの読み込みの確認
        outaddr = 3'b001;
        #STEP
        $display("Register and Register[%b] = %h",outaddr,result2);//出力データの表示
